%test script for taking fitted stick model values and creating a graphical
%representation. Also acts as preroutine for tensor and zeplin 


%These angle parameters should give a y = z diagonal 

theta = pi/4;
phi = pi/4;

%the adc will depict either how bold the stick representation will be
normalised_adc = 0.5;

%This implementation will be a 5x5 block per stick model 
grid_size = 5; 
